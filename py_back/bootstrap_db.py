...
CREATE TABLE IF NOT EXISTS "VendorMasterData" (
    ...
    "natureOfBusiness" VARCHAR(500) NULL,
    "productsServicesOffered" VARCHAR(500) NULL,
    "yearsOfExperience" VARCHAR(100) NULL,
    "annualTurnoverLast3Years" VARCHAR(500) NULL,
    "litigationDetails" VARCHAR(500) NULL,
    "blacklistingDeclaration" VARCHAR(500) NULL,
    "relatedPartyDeclaration" VARCHAR(500) NULL,
    "antiBriberyAntiCorruptionDeclaration" VARCHAR(500) NULL,
    "lowerNilTdsCertificateSection197" VARCHAR(10) NULL,
